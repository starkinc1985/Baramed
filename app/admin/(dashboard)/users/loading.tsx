  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <div className="h-7 w-20 animate-pulse rounded bg-gray-200 dark:bg-strokedark" />
          <div className="mt-1 h-4 w-28 animate-pulse rounded bg-gray-200 dark:bg-strokedark" />
        </div>
        <div className="h-9 w-28 animate-pulse rounded-lg bg-gray-200 dark:bg-strokedark" />
      </div>
          ...
          <tbody>
            {Array.from({ length: 5 }).map((_, i) => (
              <tr key={i} className="border-b border-stroke last:border-0 dark:border-strokedark">
                <td className="px-4 py-3"><div className="h-4 w-44 animate-pulse rounded bg-gray-200 dark:bg-strokedark" /></td>
                ...
                <td className="hidden px-4 py-3 lg:table-cell"><div className="h-4 w-20 animate-pulse rounded bg-gray-200 dark:bg-strokedark" /></td>
