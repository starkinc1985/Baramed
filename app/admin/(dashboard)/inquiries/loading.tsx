          ...
          <tbody>
            {Array.from({ length: 8 }).map((_, i) => (
              <tr key={i} className="border-b border-stroke last:border-0 dark:border-strokedark">
                <td className="px-4 py-3"><div className="h-4 w-32 animate-pulse rounded bg-gray-200 dark:bg-strokedark" /></td>
                <td className="hidden px-4 py-3 md:table-cell"><div className="h-4 w-40 animate-pulse rounded bg-gray-200 dark:bg-strokedark" /></td>
