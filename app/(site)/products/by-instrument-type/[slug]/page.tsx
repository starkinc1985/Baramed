            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
              {category.subcategories.map((subcat) => (
                <Link
                  ...
                  className="rounded-lg border border-stroke bg-white p-4 text-center transition-colors hover:border-primary hover:bg-primary/5 dark:border-strokedark dark:bg-blacksection"
                >
        ...
        <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
          ...
          {products.length > 0 ? (
            ...
            <div className="rounded-lg border border-stroke bg-white p-12 text-center dark:border-strokedark dark:bg-blacksection">
              <p className="text-waterloo">No products found in this category.</p>
            </div>
          )}
        </div>
      </section>
