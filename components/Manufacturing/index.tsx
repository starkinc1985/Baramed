    ...
    <section className="border-b border-stroke bg-sectionalt py-10 dark:border-strokedark dark:bg-darksectionone">
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl border border-stroke bg-white p-4 shadow-[0_2px_14px_rgba(10,30,100,0.07)] dark:border-strokedark dark:bg-darkcard">
          ...
          <div className="rounded-xl border border-stroke bg-white p-8 shadow-[0_2px_14px_rgba(10,30,100,0.07)] dark:border-strokedark dark:bg-darkcard">
