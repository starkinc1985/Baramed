...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden pb-24 pt-40 md:pt-44 xl:pb-32 xl:pt-52"
    >
      {/* Parallax background */}
      <motion.div
      ...
      {/* Overlays — kept outside parallax so they stay fixed */}
      <div className="absolute inset-0 -z-10 bg-white/40 dark:bg-black/50" />
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-white/95 via-white/75 to-white/15 dark:from-black/92 dark:via-black/65 dark:to-black/10" />
      <div className="absolute bottom-0 left-0 right-0 -z-10 h-24 bg-gradient-to-t from-bodybg to-transparent dark:from-darkbody" />

      {/* Decorative blobs */}
      <div className="absolute -top-24 right-10 -z-10 h-96 w-96 animate-float rounded-full bg-primary/6 blur-3xl dark:bg-primary/10" />
      <div className="absolute bottom-10 left-10 -z-10 h-64 w-64 rounded-full bg-meta/6 blur-3xl dark:bg-meta/10" />
